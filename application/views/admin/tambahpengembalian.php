                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="kdbk" id="kdbk" placeholder="Tulis Kode Buku atau arahkan barcode scanner" class="form-control" readonly>
                                        <span class="input-group-append">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="<?= base_url('admin/pengembalian/tambahdata'); ?>" id="form-tambah" method="post">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="w-100 bg-success">Data pengembalian</label>
                                        ...
                                        <label for="lamapinjam">Lama pengembalian (hitungan hari)</label>
                    ...
                    <tbody>
                        ...
                        foreach ($buku as $data) : ?>
                            <tr>
                                ...
                                <td><?= $data['kodebuku']; ?></td>
                                <td><?= $data['judul']; ?></td>
                                <td><a href="#" class="badge badge-primary" data-dismiss="modal" onclick="pilihBuku('<?= $data['kodebuku']; ?>')"><i class="fas fa-mouse-pointer"></i>Pilih</a></td>
                            </tr>
                        <?php $i++;
                        endforeach; ?>
                    </tbody>
...
<script>
    ...
    function pilihAnggota(kodag) {
        ...
        xmlhttp.open("POST", "<?= base_url('admin/pengembalian/cariAnggota/') ?>" + kodag, true);
        xmlhttp.send();
    }
    ...
    function pilihBuku(kodebuku) {
        ...
        xmlhttp.open("POST", "<?= base_url('admin/pengembalian/cariBuku/') ?>" + kodebuku, true);
        xmlhttp.send();
    }

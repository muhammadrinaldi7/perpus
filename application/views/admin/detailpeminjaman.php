                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php
                                    $tghitung = date('Ymd') - preg_replace('/[^0-9]/', '', $dt['tgldikembalikan']);
                                    if ($tghitung > 0) {
                                        $tgl1 = date_create($dt['tgldikembalikan']);
                                        $tgl2 = date_create();
                                        $beda = date_diff($tgl1, $tgl2);
                                        $diff = $beda->d;
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-2 d-flex justify-content-between">
                                    ...
                                    <a href="<?= base_url('admin/peminjaman/kembalikan/' . $data['kodepinjam']); ?>" class="btn btn-warning"><i class="fas fa-sign-out-alt"></i> Kembalikan</a>
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>

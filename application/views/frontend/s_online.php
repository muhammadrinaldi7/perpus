        ...
        <div class="text-justify pl-5 pr-5">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <?= form_input(['name' => 'nik', 'id' => 'nik', 'class' => 'form-control', "required" => "required", 'placeholder' => 'Silahkan masukkan NIK anda','onkeypress'=>'return hanyaAngka(event)','maxlength'=>'16','minlength'=>'16']); ?>
                </div>
                <div class="col-lg-6">
                    <label for="nama">Nama *</label>
                    <?= form_input(['name' => 'nama', 'id' => 'nama', 'class' => 'form-control', "required" => "required", 'placeholder' => 'Silahkan masukkan nama anda','onkeypress'=>'return harusHuruf(event)']); ?>
                </div>
                ...
                <div class="col-lg-6 mt-2">
                    <label for="no_hp">Jabatan *</label>
                    <?= form_input(['type' => 'text', 'name' => 'jabatan', 'id' => 'jabatan', 'class' => 'form-control', "required" => "required", 'placeholder' => 'Silahkan masukkan Jabatan anda']); ?>
                </div>
                <div class="col-lg-6 mt-2">
                    <label for="no_hp">Alamat *</label>
                    <?= form_input(['type' => 'text', 'name' => 'alamat', 'id' => 'alamat', 'class' => 'form-control', "required" => "required", 'placeholder' => 'Silahkan masukkan alamat anda']); ?>
                </div>
                <div class="col-lg-6 mt-2">
                ...
                <div class="col-lg-12 mt-2">
                    ...
                    <?= form_upload(['name' => 'file', 'id' => 'file', 'class' => 'form-control','accept'=>'.pdf']) ?>
                </div>
            </div>
            <hr>
            <small>
